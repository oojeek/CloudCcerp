 ...
 */
public class SealineMybatisGenerator {
     ...
     */
    public SealineMybatisGenerator(Configuration configuration, ShellCallback shellCallback,
    ...
    private void writeGeneratedJavaFile(GeneratedJavaFile gjf, ProgressCallback callback)
        ...
        try {
            ...
            if (targetFile.exists()) {
                // 如果包名以.dao结尾，就不覆盖了，因为Dao接口一般不用改！
                if (targetPackage.endsWith(".dao"))
                {
                    return;
                }
